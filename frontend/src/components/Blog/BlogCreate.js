...
import { PenTool, FileText, Send, Edit3, Sparkles, BookOpen } from 'lucide-react';
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              {/* Content Field */}
              <motion.div variants={itemVariants}>
                <label className="block text-gray-300 mb-2 font-medium" htmlFor="content">
                  Content
                </label>
                <div className="relative">
                  ...
                  <motion.textarea
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent text-white placeholder-gray-400 backdrop-blur-sm transition-all duration-200 min-h-[200px] resize-none"
          ...
          />
          <motion.div
            className="absolute top-1/2 -left-6 w-4 h-4 bg-gradient-to-r from-purple-400 to-blue-400 rounded-full opacity-50 blur-sm"
            animate={{
              scale: [1, 1.5, 1],
              opacity: [0.5, 0.8, 0.5],
